...
contract MintTest is Test, IUniswapV3MintCallback {
    ...
    function testSwapOne() public {
        ...
        // zero for one
        (int amount0swap, int amount1swap) = pool.swap(address(this), true, 100_000, 79228162514264337, "");
    ...
    function testSwapTwo() public {
        ...
        // zero for one
        (int amount0swap, int amount1swap) = pool.swap(address(this), false, 100_000, 779625275426524698543654961152, "");
        console.log(amount0swap);
        console.log(amount1swap);
